...
set style fill solid border -1 
set xrange[0:60]
plot 'test_volumes_2.txt' using (bin($4,binwidth)):(1.0) smooth freq with boxes lc rgb "#0072bd" notitle


set xrange[-26:-2]
set yrange[0:10]

set output "z_vs_vol_1.png"
plot 'test_volumes.txt' using 3:4 with points notitle

set output "z_vs_vol_2.png"
plot 'test_volumes_2.txt' using 3:4 with points notitle
